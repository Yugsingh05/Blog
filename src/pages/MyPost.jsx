...
function MyPost() {
  ...
  if (posts.length === 0) {
    return (
        <div className="w-full py-8 mt-2 text-center bg-slate-900 my-8">
            <Container>
                <div className="flex flex-wrap align-content-center justify-center">
                    <div className="p-5 w-full ">
                      + <h1 className="text-2xl myp font-bold hover:text-red-500 text-white">
